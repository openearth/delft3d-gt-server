from os import walk, stat, remove, rename
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for root, dirs, files in walk(settings.WORKER_FILEDIR):
            ...
            if (basename(root) == 'simulation' and 'done' in files and
                    netcdf in files and netcdf_compressed not in files):
                ...
                command = "ncks -4 -L 1 {}/{} {}/{}".format(root, netcdf, root, netcdf_compressed)
                ...
                if not call(command, shell=True):
                    ...
                    self.stdout.write('Compressed {} to with ratio: {}'.format(netcdf, ratio))
