...
from delft3dworker.permissions import ViewObjectPermissions, HasViewPermission
...
class SceneViewSet(viewsets.ModelViewSet):
    ...
    @action(methods=["put"], detail=True, permission_classes=[permissions.IsAuthenticated, HasViewPermission])
